...
import type { CarAcrissCodeDictionaryItem } from './car-acriss-code-dictionary-item';
import type { CarCompanyDictionaryItem } from './car-company-dictionary-item';
import type { CarLocationDictionaryItem } from './car-location-dictionary-item';
import type { CurrencyDictionaryItem } from './currency-dictionary-item';

export interface CarOrderDictionary {
  /**
   * Car location details corresponding to a car location id. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  location?: Record<string, CarLocationDictionaryItem>;
  /**
   * Car company details map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  company?: Record<string, CarCompanyDictionaryItem>;
  /**
   * Car acriss codes map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  acriss?: Record<string, CarAcrissCodeDictionaryItem>;
  /**
   * Car shuttle information map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  shuttle?: Record<string, string>;
  /**
   * Description of a rating criterion
   */
  ratingCriterion?: Record<string, string>;
  /**
   * Coverage types map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  coverage?: Record<string, string>;
  /**
   * Special equipment types map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  specialEquipment?: Record<string, string>;
  /**
   * Surcharge types map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  surcharge?: Record<string, string>;
  /**
   * Tax types map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  tax?: Record<string, string>;
  /**
   * Fuel policy map used in rate info. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  fuelPolicy?: Record<string, string>;
  /**
