...
/**
 * A ticket payment surcharge contains: - the surcharge to apply in the TST - the list of travelers associated to the TST in which the surcharge is applied. The surcharge is represented as a tax in the TST. The items to be covered by the ticket payment surcharge are mandatory. - The API user  needs to provide the details for the surcharge to be applied, and the traveler ids that the tax is applied to. - If this is not provided, the surcharge will not be applied.
 */
export interface TicketPaymentSurcharge {
  /**
  ...
  code?: string;
  /**
   * in a context of a reissue, flag indicating if the surcharge is related to the first issue (old) or the reissue (new or refundable)
   */
  category?: TicketPaymentSurchargeCategory;
  /**
   ...
   */
  pricingTimeWindow?: TicketPaymentSurchargePricingTimeWindow;
  /**
...
export enum TicketPaymentSurchargeCategory {
  Old = 'OLD',
  New = 'NEW',
...
export enum TicketPaymentSurchargePricingTimeWindow {
  Hourly = 'hourly',
  Daily = 'daily',
  Monthly = 'monthly',
  Weekend = 'weekend',
