...
import type { HotelItem } from './hotel-item';
...
export interface Order {
  ...
  /**
   * Expiration date of the order in GMT (Example: 2018-02-10T20:40:12Z). Will be deprecated in V3, please rather use Payment Time Limit / Issuance Time Limit.
   */
  ...
  /**
   * Generic fare elements or fare remarks stored in the order. Only some types are available like the tour code (FT).
   */
  ...
  /**
   * List of Hotel (HHL) details booked in Order
   */
  hotels?: HotelItem[];
  /**
