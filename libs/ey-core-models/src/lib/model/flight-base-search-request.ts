 ...
 */
import type { FlightEndPointSearchRequest } from './flight-end-point-search-request';

/**
 * Flight basic information corresponding to a flight id. A flight element may be composed of several legs (FlightEndPointSearchRequest).
 */
export interface FlightBaseSearchRequest {
  /**
   ...
   */
  suffix?: string;
  departure: FlightEndPointSearchRequest;
  arrival: FlightEndPointSearchRequest;
  /**
