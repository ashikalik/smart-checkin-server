 ...
 */
export interface AdvancedAirCalendarItinerary {
  /**
   ...
   */
  originLocationType?: AdvancedAirCalendarItineraryOriginLocationType;
  /**
   * Specify the type of the destination location between city or airport (state is not supported).
   */
  destinationLocationType?: AdvancedAirCalendarItineraryDestinationLocationType;
  /**
  ...
  stopOver?: StopOver;
  /**
   * Commercial fare families to be used for the chosen bound. Must not be provided along with commercial fare families for the entire trip at itinerary level.
   */
  commercialFareFamilies?: string[];
  /**
   * This defines which bound needs to be kept for the bound-by-bound search, in the given itinerary. In case \"isRequestedBound: true\" corresponding flexibility cannot be 0, it will be defaulted to 3. In case \"isRequestedBound: false\" flexibility selection will not be allowed (therefore no default value defined).
   */
  isRequestedBound?: boolean;
}
export enum AdvancedAirCalendarItineraryOriginLocationType {
  Airport = 'airport',
  City = 'city',
}
export enum AdvancedAirCalendarItineraryDestinationLocationType {
  Airport = 'airport',
  City = 'city',
}
