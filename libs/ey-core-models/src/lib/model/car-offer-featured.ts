 ...
 */
import type { CarAdditionalOptions } from './car-additional-options';
import type { CarPricingRecords } from './car-pricing-records';
import type { CarRateDetails } from './car-rate-details';
import type { CarRateRanking } from './car-rate-ranking';
import type { LoyaltyNumbersItem } from './loyalty-numbers-item';
import type { Vehicle } from './vehicle';

/**
 * Object containing the information related to a car offer and additional information exclusively related to teaser.
 */
export interface CarOfferFeatured {
  /**
   ...
   */
  loyaltyNumbers?: LoyaltyNumbersItem[];
  rateDetails: CarRateDetails;
  /**
   * Booking agency number used for this offer
   */
  bookingAgency?: string;
  prices: CarPricingRecords;
  ranking?: CarRateRanking;
  bookableOptions?: CarAdditionalOptions;
  /**
  ...
  id: string;
  /**
   * ordinal number of the offer after ordering
   */
  displayOrder?: number;
}
