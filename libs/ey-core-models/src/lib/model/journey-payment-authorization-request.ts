 ...
 */
export interface JourneyPaymentAuthorizationRequest {
  /**
   ...
   */
  paymentOperationType?: JourneyPaymentAuthorizationRequestPaymentOperationType;
  /**
   ...
   */
  paymentAction?: JourneyPaymentAuthorizationRequestPaymentAction;
  paymentMethod?: PaymentMethod;
}
export enum JourneyPaymentAuthorizationRequestPaymentOperationType {
  Services = 'services',
  Upgrade = 'upgrade',
  StandbyEarly = 'standbyEarly',
  SameDayChange = 'sameDayChange',
}
export enum JourneyPaymentAuthorizationRequestPaymentAction {
  Add = 'add',
}
