...
import type { FlightInformationArrivalTimings } from './flight-information-arrival-timings';
import type { FlightInformationDepartureTimings } from './flight-information-departure-timings';
import type { FlightInformationDiversionAirport } from './flight-information-diversion-airport';
import type { Meal } from './meal';

export interface FlightInformationFlightStop {
  /**
  ...
  aircraftCode?: string;
  /**
   * IATA airline code (http://www.iata.org/publications/Pages/code-search.aspx). Defines the aircraft owner airline code for the flight departing from the technical stop\'s location.
   */
  ...
  departureTimings?: FlightInformationDepartureTimings;
  arrivalTimings?: FlightInformationArrivalTimings;
  diversion?: FlightInformationDiversionAirport;
  /**
   ...
   */
  flightStatus?: FlightInformationFlightStopFlightStatus;
...
export enum FlightInformationFlightStopFlightStatus {
  Scheduled = 'scheduled',
  Departed = 'departed',
  Cancelled = 'cancelled',
  Delayed = 'delayed',
