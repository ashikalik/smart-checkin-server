...
export interface AirOfferConditionDictionary {
  /**
  ...
  /**
   * Fare condition category map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  airOfferConditionCategory?: Record<string, string>;
  /**
   * Fare condition situation map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  airOfferConditionSituation?: Record<string, string>;
  /**
