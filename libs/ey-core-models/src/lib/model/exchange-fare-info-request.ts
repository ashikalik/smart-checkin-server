...
/**
 * Details of the fare information to be used for the repricing of the itinerary after flight exchange in a air bound exchange process with association to related flights and/or travelers.
 */
export interface ExchangeFareInfoRequest {
  /**
   ...
   */
  hotelIds?: string[];
  fareType?: ExchangeFareInfoRequestFareType;
  fareClass?: string;
  /**
   * Passenger type code requested to price a given traveler
   */
  ...
  /**
   * Passenger type discount codes used to biase the air offers pricing, corresponding to  the requested discounts. Depending on the pricing conditions, those discounts may not  be applied when the air offer is priced. Example: MIL, ICA
   */
  passengerTypeDiscountCodes?: string[];
  /**
   * Corporate code used by the airline to target a given fare
   */
  corporateCode?: string;
}
export enum ExchangeFareInfoRequestFareType {
  Public = 'public',
  Unifares = 'unifares',
}
