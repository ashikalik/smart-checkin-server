...
/**
 * Full fare conditions applicable to the requested passengers  and flights being part of the itinerary.
 */
export interface RawAirOfferCondition {
  travelerIds?: string[];
  flightIds?: string[];
  /**
   * ATPCO category of the condition (e.g. Change conditions, Stopover ...)
   */
  category?: RawAirOfferConditionCategory;
  /**
   * Raw description corresponding to the fare conditions of given fare category
   */
  rawDescription?: string;
}
export enum RawAirOfferConditionCategory {
