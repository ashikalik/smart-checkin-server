...
import type { StopOver } from './stop-over';
...
export interface Itinerary {
  ...
  /**
   * Specify the type of the origin location between city or airport (state is not supported).
   */
  originLocationType?: ItineraryOriginLocationType;
  /**
   * Specify the type of the destination location between city or airport (state is not supported).
   */
  destinationLocationType?: ItineraryDestinationLocationType;
  /**
  ...
  /**
   * Time window in hours for the bound (first flight). E.g: departureTimeWindow=2 means from 2 hours before, until 2 hours after the departure time. The value 0 is considered as there is no time window.
   */
  departureTimeWindow?: number;
  /**
  ...
  /**
   * DEPRECATED Return date and time for the inbound (first return flight) in ISO 8601 [http://www.w3.org/TR/NOTE-datetime]. It specifies date and hours of the search (eg. 2017-11-10T10:21:00)
   */
   ...
   */
  departureCommercialFareFamilies?: string[];
  /**
   * DEPRECATED Commercial fare families to be used for inbound. Must be provided along with departureCommercialFareFamilies in case of RoundTrip. Must not be provided along with commercialFareFamilies for the entire trip at itinerary level.
   */
  returnCommercialFareFamilies?: string[];
  /**
   * DEPRECATED \"Time window for the return trip or continuation of an open-jaw. E.g: A returnTimeWindow=2 means from 2 hours before, until 2 hours after the return time. The value 0 is considered as there is no time window.\"
   */
  returnTimeWindow?: number;
  departureStopOver?: StopOver;
  returnStopOver?: StopOver;
  /**
   * Temporary id used for as bound identifier for more flight research in complex itinerary Tid should be consecutive, no skip in tid value, meaning that if you have 3 bounds in your itinerary, you should not have tid = 4
   */
  tid?: number;
}
export enum ItineraryOriginLocationType {
  Airport = 'airport',
  City = 'city',
}
export enum ItineraryDestinationLocationType {
  Airport = 'airport',
  City = 'city',
}
