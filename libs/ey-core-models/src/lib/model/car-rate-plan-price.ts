...
import type { SpecialEquipment } from './special-equipment';
 ...
 */
export interface CarRatePlanPrice {
  /**
  ...
  totalTaxes: number;
  /**
   * Surcharges breakdown.The Surcharge details will be unavailable in the shopping response
   */
  surcharges?: Surcharge[];
  /**
   * Sum of all surcharges. The Surcharge details will be unavailable in the shopping response
   */
   ...
   */
  pricingTimeWindow?: CarRatePlanPricePricingTimeWindow;
}
export enum CarRatePlanPricePricingTimeWindow {
  Hourly = 'hourly',
  Daily = 'daily',
  Monthly = 'monthly',
  Weekend = 'weekend',
