 ...
 */
import type { BagTagDeliveryEligibility } from './bag-tag-delivery-eligibility';
import type { TravelerIdentifier } from './traveler-identifier';
...
export interface Baggage {
   ...
   */
  travelerIds: TravelerIdentifier[];
  /**
   ...
   */
  acceptanceStatus: BaggageAcceptanceStatus;
  /**
   ...
   */
  bagTagPrintStatus: BaggageBagTagPrintStatus;
   ...
   */
  specialBagType?: string;
  /**
   * Baggage identifier - to identify the returned weight is total weight or individual weight
   */
  weightType?: BaggageWeightType;
}
...
export enum BaggageAcceptanceStatus {
  NotAccepted = 'notAccepted',
  FullyAccepted = 'fullyAccepted',
  StandBy = 'standBy',
  StatusNotSupportedInThisVersion = 'statusNotSupportedInThisVersion',
}
export enum BaggageBagTagPrintStatus {
  PrintingRequired = 'printingRequired',
  Printed = 'printed',
}
export enum BaggageWeightUnit {
  Kilogram = 'kilogram',
  Pound = 'pound',
}
export enum BaggageWeightType {
  TotalBagWeight = 'totalBagWeight',
  IndividualBagWeight = 'individualBagWeight',
}
