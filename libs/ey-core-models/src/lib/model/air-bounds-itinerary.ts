 ...
 */
export interface AirBoundsItinerary {
  /**
   ...
   */
  originLocationType?: AirBoundsItineraryOriginLocationType;
  /**
   * Specify the type of the destination location between city or airport (state is not supported).
   */
  destinationLocationType?: AirBoundsItineraryDestinationLocationType;
  /**
...
export enum AirBoundsItineraryOriginLocationType {
  Airport = 'airport',
  City = 'city',
}
export enum AirBoundsItineraryDestinationLocationType {
  Airport = 'airport',
  City = 'city',
}
