...
import type { PaymentWithAssociationRequest } from './payment-with-association-request';
...
export interface PostOrderRequest {
  /**
   * Preferred numeric id that the traveler can use to retrieve the order later on
   */
  numericId?: string;
  /**
   ...
   */
  paymentRequests?: PaymentWithAssociationRequest[];
  /**
  ...
  /**
   * prevent duplicate bookings with the same cart id.
   */
  allowOnlyOneOrderPerCart?: boolean;
}
