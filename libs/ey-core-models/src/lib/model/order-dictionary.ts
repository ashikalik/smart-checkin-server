 ...
 */
import type { BookingStatusDictionaryItem } from './booking-status-dictionary-item';
import type { CarDictionary } from './car-dictionary';
import type { CurrencyDictionaryItem } from './currency-dictionary-item';
import type { DiscountDictionaryItem } from './discount-dictionary-item';
import type { DynamicWaiverDictionaryItem } from './dynamic-waiver-dictionary-item';
import type { FareFamilyDictionaryItem } from './fare-family-dictionary-item';
import type { FareFamilyWithServicesDictionaryItem } from './fare-family-with-services-dictionary-item';
import type { Flight } from './flight';
import type { Hotel } from './hotel';
import type { InstallmentPlanData } from './installment-plan-data';
import type { InsuranceProviderDictionaryItem } from './insurance-provider-dictionary-item';
import type { LocationDictionaryItem } from './location-dictionary-item';
import type { SeatCharacteristicDictionaryItem } from './seat-characteristic-dictionary-item';
import type { ServiceDictionaryItem } from './service-dictionary-item';
import type { SpecialServiceRequestDictionaryItem } from './special-service-request-dictionary-item';

export interface OrderDictionary {
  /**
   * Locations map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  location?: Record<string, LocationDictionaryItem>;
  /**
   * Countries map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  country?: Record<string, string>;
  /**
   * Airlines map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  airline?: Record<string, string>;
  /**
   * Aircrafts map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  aircraft?: Record<string, string>;
  /**
   * Flight information corresponding to a flight id. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  flight?: Record<string, Flight>;
  /**
   * Reference to InsuranceProvider dictionary
   */
  insuranceProvider?: Record<string, InsuranceProviderDictionaryItem>;
  /**
   * Fare families map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  fareFamily?: Record<string, FareFamilyDictionaryItem>;
  /**
   * Fare families with services map. For more details please see [Maps in dictionary documentation] (../../display/documentation.html#/Maps/get_)
   */
  fareFamilyWithServices?: Record<string, FareFamilyWithServicesDictionaryItem>;
  /**
   * Services map. For more details please see [Maps in dictionary documentation] (../../display/documentation.html#/Maps/get_)
   */
  service?: Record<string, ServiceDictionaryItem>;
  /**
   * Taxes map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  tax?: Record<string, string>;
  /**
   * Surcharges map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  surcharge?: Record<string, string>;
  /**
   * Currencies map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  currency?: Record<string, CurrencyDictionaryItem>;
  /**
   * Seat characteristics map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  seatCharacteristic?: Record<string, SeatCharacteristicDictionaryItem>;
  /**
   * Special service requests map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  specialServiceRequest?: Record<string, SpecialServiceRequestDictionaryItem>;
  /**
   * Status map for flights, services, seats and special service requests. For more details please see [Maps in dictionary documentation] (../../display/documentation.html#/Maps/get_)
   */
  bookingStatus?: Record<string, BookingStatusDictionaryItem>;
  /**
   * Status map for meal codes. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  meal?: Record<string, string>;
  /**
   * When a flight change is encouraged due to an anticipated disruption, you will will be allowed  to change the flight within the given conditions and the penalty for that flight change is then waived. If a waiver is offered, the conditions for the flight change are described here. [documentation](../../display/documentation.html#/Maps/get_)
   */
  waivers?: Record<string, DynamicWaiverDictionaryItem>;
  /**
   * Details about the discounts. The reference currency is the one defined at Price level.
   */
  discount?: Record<string, DiscountDictionaryItem>;
  /**
   ...
   */
  installmentPlan?: Record<string, InstallmentPlanData>;
  /**
   * Deprecated. Details about the hotel booked in the order.For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  hotel?: Record<string, Hotel>;
  /**
   * Details about the hotel booked in the order.For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  hotelDetails?: Record<string, Hotel>;
  carDictionary?: CarDictionary;
}
