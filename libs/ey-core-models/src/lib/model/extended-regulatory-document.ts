 ...
 */
export interface ExtendedRegulatoryDocument {
  /**
   ...
   */
  gender?: ExtendedRegulatoryDocumentGender;
  /**
   ...
   */
  documentType: ExtendedRegulatoryDocumentDocumentType;
  inputSource?: InputSource;
}
export enum ExtendedRegulatoryDocumentGender {
  Male = 'male',
  Female = 'female',
  Unspecified = 'unspecified',
  Unknown = 'unknown',
}
export enum ExtendedRegulatoryDocumentDocumentType {
  Passport = 'passport',
  ...
  Visa = 'visa',
  LongStayVisa = 'longStayVisa',
  MultipleEntryVisa = 'multipleEntryVisa',
  ...
  NexusCard = 'nexusCard',
  IndianOverseasCitizenshipCard = 'indianOverseasCitizenshipCard',
}
