 ...
 */
import type { FlightDelay } from './flight-delay';
import type { FlightInformationAirlineCommon } from './flight-information-airline-common';
import type { FlightInformationArrivalEndPoint } from './flight-information-arrival-end-point';
import type { FlightInformationDepartureEndPoint } from './flight-information-departure-end-point';
import type { FlightInformationFlightStop } from './flight-information-flight-stop';
import type { FlightInformationOperatingFlight } from './flight-information-operating-flight';
...
export interface FlightInformation {
  departure?: FlightInformationDepartureEndPoint;
  arrival?: FlightInformationArrivalEndPoint;
  marketingFlight?: FlightInformationAirlineCommon;
  operatingFlight?: FlightInformationOperatingFlight;
  /**
   * Open segment
   */
   ...
   */
  stops?: FlightInformationFlightStop[];
  /**
   ...
   */
  availableBookingClasses: string[];
  /**
   * status of the flight
   */
  flightStatus: FlightInformationFlightStatus;
...
export enum FlightInformationFlightStatus {
  Scheduled = 'scheduled',
