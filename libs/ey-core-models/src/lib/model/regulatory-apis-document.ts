 ...
 */
export interface RegulatoryApisDocument {
  /**
   ...
   */
  gender?: RegulatoryApisDocumentGender;
  /**
   ...
   */
  documentType: RegulatoryApisDocumentDocumentType;
}
export enum RegulatoryApisDocumentGender {
  Male = 'male',
  Female = 'female',
  Unspecified = 'unspecified',
  Unknown = 'unknown',
}
export enum RegulatoryApisDocumentDocumentType {
  Passport = 'passport',
