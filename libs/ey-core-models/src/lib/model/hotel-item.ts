...
import type { FrequentFlyer } from './frequent-flyer';
import type { Guests } from './guests';
import type { HotelPrice } from './hotel-price';
import type { LoyaltyAward } from './loyalty-award';
import type { PolicyDetails } from './policy-details';
import type { RateFamily } from './rate-family';
import type { RoomDetails } from './room-details';
import type { TextWithLanguageType } from './text-with-language-type';
...
export interface HotelItem {
  ...
  rateCode?: string;
  /**
   * name of the rate, a summary of the rateCode description
   */
  rateName?: string;
   ...
   */
  category?: string;
  description?: TextWithLanguageType;
  ...
  pointsAccrual?: LoyaltyAward;
  /**
   * Id to be used for the interaction with order
   */
  id: string;
  /**
   * Confirmation number related to the hotel booking
   */
