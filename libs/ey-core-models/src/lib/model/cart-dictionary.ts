 ...
 */
import type { AnonymousTraveler } from './anonymous-traveler';
...
export interface CartDictionary {
  ...
  /**
   * Information about a traveler such as first and last name. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  traveler?: Record<string, Traveler>;
  /**
  ...
  /**
   * Hotel details information map. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
