...
/**
 * Reply containing a list of processed notifications with their status and format.  Note: Today, only contentType \'travelDocumentReceipt\' is supported.
 */
export interface TravelDocumentNotificationsData {
  /**
   ...
   */
  contentType: TravelDocumentNotificationsDataContentType;
  /**
   ...
   */
  format: TravelDocumentNotificationsDataFormat;
  /**
   ...
   */
  status: TravelDocumentNotificationsDataStatus;
  /**
  ...
  link?: Url;
  /**
   * Temporary id that can be used to associate requested and returned notifications. Valid only for the time of the transaction
   */
  tid?: string;
  /**
   * Process performed by the endpoint
   */
  type: TravelDocumentNotificationsDataType;
  /**
   * The travel documents covered by this notification.
   */
  documentIds: string[];
}
export enum TravelDocumentNotificationsDataContentType {
  TravelDocumentReceipt = 'travelDocumentReceipt',
  Itinerary = 'itinerary',
  Invoice = 'invoice',
}
export enum TravelDocumentNotificationsDataFormat {
  Email = 'email',
  Link = 'link',
}
export enum TravelDocumentNotificationsDataStatus {
  Sent = 'sent',
  Created = 'created',
  Error = 'error',
}
export enum TravelDocumentNotificationsDataType {
