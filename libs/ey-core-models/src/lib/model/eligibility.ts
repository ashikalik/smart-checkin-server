...
export enum EligibilityReasons {
  FirstFlightOtherAirline = 'firstFlightOtherAirline',
  FirstFlightOnOtherDepartureControlSystem = 'firstFlightOnOtherDepartureControlSystem',
  FlightAcceptanceEligibilityWindow = 'flightAcceptanceEligibilityWindow',
  FlightAcceptanceDefaultEligibilityWindow = 'flightAcceptanceDefaultEligibilityWindow',
  FlightEligibilityRule = 'flightEligibilityRule',
  FlightEligibilityDefaultRule = 'flightEligibilityDefaultRule',
  FlightGeneralStatus = 'flightGeneralStatus',
  FlightAcceptanceStatus = 'flightAcceptanceStatus',
  DepartureAirportInhibited = 'departureAirportInhibited',
  ArrivalAirportInhibited = 'arrivalAirportInhibited',
  FirstFlightIsInhibited = 'firstFlightIsInhibited',
  PassiveSegment = 'passiveSegment',
  PreviousFlightIsInhibited = 'previousFlightIsInhibited',
  InfantStatusNeedToBeChecked = 'infantStatusNeedToBeChecked',
  InfantAgeToBeChecked = 'infantAgeToBeChecked',
  ChildAgeToBeChecked = 'childAgeToBeChecked',
  TicketProblem = 'ticketProblem',
  TicketTypeNotAllowed = 'ticketTypeNotAllowed',
  HighPriorityComment = 'highPriorityComment',
  CustomerEligibilityRule = 'customerEligibilityRule',
  OperationalStatusNotSupported = 'operationalStatusNotSupported',
  ServiceRequestNotSupported = 'serviceRequestNotSupported',
  UnpaidService = 'unpaidService',
  RegulatoryDetailsInhibition = 'regulatoryDetailsInhibition',
  RegulatoryDetailsLimitations = 'regulatoryDetailsLimitations',
  RegulatoryDetailsNameNotMatching = 'regulatoryDetailsNameNotMatching',
  RegulatoryDetailsMultipleNationality = 'regulatoryDetailsMultipleNationality',
  RegulatoryDetailsStatusNotAuthorized = 'regulatoryDetailsStatusNotAuthorized',
  RegulatoryDetailsPassportExpired = 'regulatoryDetailsPassportExpired',
  ReprintingIsInhibited = 'reprintingIsInhibited',
  AlreadyBoarded = 'alreadyBoarded',
  VisaNeedAgentVerification = 'visaNeedAgentVerification',
  IneligibleBookingstatus = 'ineligibleBookingstatus',
  IneligibleNonRevenuePassenger = 'ineligibleNonRevenuePassenger',
  FlightIsDisrupted = 'flightIsDisrupted',
  PassengerAlreadyAccepted = 'passengerAlreadyAccepted',
  ReasonNotSupportedInThisVersion = 'reasonNotSupportedInThisVersion',
  ItinerarySequenceCheck = 'itinerarySequenceCheck',
  CustomerTypeCheck = 'customerTypeCheck',
  DeeplinkInhibition = 'deeplinkInhibition',
  IneligibleSpecialRequest = 'INELIGIBLE_SPECIAL_REQUEST',
  OutboundNotCheckedin = 'OUTBOUND_NOT_CHECKEDIN',
}
