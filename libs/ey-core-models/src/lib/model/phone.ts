...
export interface Phone extends Contact {
  ...
  lang?: string;
  /**
   * Code of the city (e.g. LON for London) associated to the Phone contact. Information available only at Cart and Order management time.
   */
  cityCode?: string;
  /**
   * Freetext of the contact, based on actual API user rights.
   */
  freeFlowText?: string;
}
