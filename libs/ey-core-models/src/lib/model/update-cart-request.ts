 ...
 */
import type { AirOfferTravelerSelection } from './air-offer-traveler-selection';
...
import type { ServiceMilesRedemptionRequest } from './service-miles-redemption-request';
import type { Traveler } from './traveler';
import type { UpdateCartSeatItemRequest } from './update-cart-seat-item-request';
import type { UpdateCartServiceItemRequest } from './update-cart-service-item-request';
...
export interface UpdateCartRequest {
   ...
   */
  airOfferTravelerSelections?: AirOfferTravelerSelection[];
  /**
   * DEPRECATED Cart label or name.  This field is not processed by Digital Commerce API and will be removed in V3.
   */
  title?: string;
  /**
   * DEPRECATED Cart state (list to be defined during development) This field is not processed by Digital Commerce API and will be removed in V3.
   */
  state?: string;
  /**
   ...
   * List of services
   */
  services?: UpdateCartServiceItemRequest[];
  /**
   * List of seats
   */
  seats?: UpdateCartSeatItemRequest[];
  milesRedemptionDetails?: ServiceMilesRedemptionRequest;
}
