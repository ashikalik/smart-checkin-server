...
import type { CheckInFlightIdObject } from './check-in-flight-id-object';
import type { CheckinSystem } from './checkin-system';
import type { Contact } from './contact';
import type { Eligibility } from './eligibility';
import type { JourneyDisruption } from './journey-disruption';
import type { JourneyElementCommon } from './journey-element-common';
...
export interface Journey {
   ...
   */
  journeyElements: JourneyElementCommon[];
  /**
  ...
  /**
   * Redirection URL to bring users to partner (operating) airline\'s application for check-in.
   */
  deeplinkRedirectionUrl?: string;
  disruption?: JourneyDisruption;
}
