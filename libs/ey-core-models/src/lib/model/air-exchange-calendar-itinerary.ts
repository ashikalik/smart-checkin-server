...
export interface AirExchangeCalendarItinerary {
   ...
   */
  originLocationType?: AirExchangeCalendarItineraryOriginLocationType;
  /**
   * Specify the type of the destination location between city or airport (state is not supported).
   */
  destinationLocationType?: AirExchangeCalendarItineraryDestinationLocationType;
  /**
  ...
  flexibility?: number;
  /**
   * ID of the bound to be considered in the associated Order.
   */
  boundId?: string;
  /**
   * Action to be done for this bound. Several operations are supported: - Change : Change the bound specified (new date and/or new origin/destination) - Keep: Keep the current bound and display the price without any modification - Add : Add a bound to an Order - Remove : Remove a bound from an Order
   */
  action?: AirExchangeCalendarItineraryAction;
  /**
   * This defines which bound needs to searched for the bound-by-bound search, in the given itinerary.
   */
  isRequestedBound?: boolean;
}
export enum AirExchangeCalendarItineraryOriginLocationType {
  Airport = 'airport',
  City = 'city',
}
export enum AirExchangeCalendarItineraryDestinationLocationType {
  Airport = 'airport',
  City = 'city',
}
export enum AirExchangeCalendarItineraryAction {
  Change = 'change',
  Keep = 'keep',
  Add = 'add',
  Remove = 'remove',
