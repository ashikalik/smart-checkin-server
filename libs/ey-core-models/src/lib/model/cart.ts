 ...
 */
import type { AirOffer } from './air-offer';
import type { CarOffer } from './car-offer';
...
import type { HotelOffer } from './hotel-offer';
import type { InsuranceCommonItem } from './insurance-common-item';
import type { PointOfSaleCommon } from './point-of-sale-common';
import type { SeatItem } from './seat-item';
...
export interface Cart {
   ...
   */
  id: string;
  creationPointOfSale?: PointOfSaleCommon;
  /**
   ...
   */
  hotelItems?: HotelOffer[];
  /**
   * List of selected insurance offers
   */
  insurances?: InsuranceCommonItem[];
  /**
   * (UNDER CONSTRUCTION - DO NOT USE) List of contact items for unaccompanied minor
   */
