 ...
 */
export interface RegulatoryFoidDocument {
  /**
   ...
   */
  gender?: RegulatoryFoidDocumentGender;
  /**
   ...
   */
  documentType: RegulatoryFoidDocumentDocumentType;
}
export enum RegulatoryFoidDocumentGender {
  Male = 'male',
  Female = 'female',
  Unspecified = 'unspecified',
  Unknown = 'unknown',
}
export enum RegulatoryFoidDocumentDocumentType {
  Passport = 'passport',
