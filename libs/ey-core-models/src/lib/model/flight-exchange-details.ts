 ...
 */
import type { FlightBasicEndPoint } from './flight-basic-end-point';

/**
 * Details of the new flight to be booked in order air bound exchange
 */
export interface FlightExchangeDetails {
  /**
   ...
   */
  id?: string;
  departure?: FlightBasicEndPoint;
  arrival?: FlightBasicEndPoint;
  /**
   * Booking class
   */
  bookingClass?: string;
