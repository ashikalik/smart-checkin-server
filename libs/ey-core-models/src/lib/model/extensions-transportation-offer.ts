...
import type { ExternalTransportationBooking } from './external-transportation-booking';
import type { MediaUri } from './media-uri';
import type { TransportationCompany } from './transportation-company';
import type { TransportationOfferDetails } from './transportation-offer-details';

/**
 * Transportation offers to be saved as extensions in the cart
 */
export interface ExtensionsTransportationOffer {
  /**
   * Transportation  Offer Id
   */
  id?: string;
  /**
   * Type of transportation offer
   */
  transportationType: ExtensionsTransportationOfferTransportationType;
  /**
   * Description of transportation type
   */
  description?: string;
  pickUp: TransportationOfferDetails;
  dropOff: TransportationOfferDetails;
  ...
  /**
   * Number of services booked. For example - number of bus tickets bought, number of cars rented
   */
  numberOfServices: number;
  /**
   * Number of baggages supported
   */
  baggageCapacity?: number;
  externalTransportationBooking?: ExternalTransportationBooking;
  /**
   * Details of the transportation Media
   */
  media?: MediaUri[];
  price?: Amount;
}
export enum ExtensionsTransportationOfferTransportationType {
  Car = 'car',
  Bus = 'bus',
  Taxi = 'taxi',
  Train = 'train',
