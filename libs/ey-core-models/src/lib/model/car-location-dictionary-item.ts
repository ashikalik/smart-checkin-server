 ...
 */
import type { AddressBase } from './address-base';
import type { CarLocationDictionaryItemContact } from './car-location-dictionary-item-contact';
import type { CarLocationDictionaryItemGeoLocalization } from './car-location-dictionary-item-geo-localization';
import type { CarLocationDictionaryItemLocation } from './car-location-dictionary-item-location';
import type { CarTermsAndCondition } from './car-terms-and-condition';
 ...
 */
export interface CarLocationDictionaryItem {
  address?: AddressBase;
  location: CarLocationDictionaryItemLocation;
  /**
   * 2 letters provider code
   */
  companyCode?: string;
  geoLocalization?: CarLocationDictionaryItemGeoLocalization;
  ...
  contact?: CarLocationDictionaryItemContact;
  /**
   ...
   */
  termsAndConditions?: CarTermsAndCondition[];
  /**
