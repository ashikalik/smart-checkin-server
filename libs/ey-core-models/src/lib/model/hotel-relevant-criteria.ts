 ...
 */
export interface HotelRelevantCriteria {
  /**
  ...
  quantity?: number;
  /**
   * Number of adults per room.  if adults = 2 and quantity = 2, total number of adults is 4.
   */
  adults: number;
  /**
   * List of ages of each child per room. If 2 children have the same age, it will be repeated here. if childAges contains 2 ages and quantity = 2, total number of children is 4.
   */
  childAges?: number[];
  /**
   * Name of the hotel
  ...
  providers?: Provider[];
  /**
   * List of hotel brand codes to filter the response by. A brand code is used to identify the physical hotel supplier when the hotel is provided by an aggregator. For example, RT is the brand code of ACCOR Hotels.
   */
  brandCodes?: string[];
  /**
   ...
   */
  orderBy?: HotelRelevantCriteriaOrderBy;
  /**
   ...
   * Radius unit.
   */
  radiusUnit?: HotelRelevantCriteriaRadiusUnit;
  /**
   * List of hotel star ratings to filter the response by.
   */
  ratings?: number[];
  maxPricePerNight?: Amount;
  /**
   * Requested board type (meal).
   */
  boardType?: HotelRelevantCriteriaBoardType;
  /**
   * List of hotel amenities to filter the search response by.
   */
  amenities?: HotelRelevantCriteriaAmenities[];
}
export enum HotelRelevantCriteriaOrderBy {
  PriceAsc = 'priceAsc',
  PriceDesc = 'priceDesc',
  StarRatingAsc = 'starRatingAsc',
  StarRatingDesc = 'starRatingDesc',
}
export enum HotelRelevantCriteriaRadiusUnit {
  Km = 'km',
  Mile = 'mile',
}
export enum HotelRelevantCriteriaBoardType {
  RoomOnly = 'ROOM_ONLY',
  Breakfast = 'BREAKFAST',
...
export enum HotelRelevantCriteriaAmenities {
