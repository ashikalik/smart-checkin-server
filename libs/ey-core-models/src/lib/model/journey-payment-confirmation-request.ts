...
export interface JourneyPaymentConfirmationRequest {
   ...
   */
  paymentOperationType?: JourneyPaymentConfirmationRequestPaymentOperationType;
  /**
   * List of IDs of individual upgrades that the customer has selected
   */
  upgradeIds?: string[];
  /**
   * List of IDs of individual chargeable seats that the customer has selected
   */
  seatItemIds?: string[];
  /**
   * List of IDs of individual excess bags that the customer has selected
   */
  baggageItemIds?: string[];
  /**
   * List of IDs of individual services that the customer has selected
   */
  ...
  returnUrl?: string;
  /**
   * A list of payment request. Each payment request contains a payment method, and the amount to be paid using that method. The API supports only payment with 1 PaymentCard today.
   */
  paymentRequests?: JourneyPaymentWithAssociationRequest[];
  /**
   ...
   */
  authorizationSuccessful?: boolean;
}
export enum JourneyPaymentConfirmationRequestPaymentOperationType {
  Services = 'services',
  Upgrade = 'upgrade',
