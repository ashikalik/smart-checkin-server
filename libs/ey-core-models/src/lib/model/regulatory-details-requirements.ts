 ...
 */
export interface RegulatoryDetailsRequirements {
  regulatoryType: RegulatoryDetailsRequirementsRegulatoryType;
  /**
   * Type of the regulatory details to be filled
   */
  detailsType: RegulatoryDetailsRequirementsDetailsType;
  /**
   * List of the fields required for those details
   */
  requiredDetailsFields: RegulatoryDetailsRequirementsRequiredDetailsFields[];
  /**
   * Indicate if the regulatory details can be declined by the traveler.
   */
  canBeDeclined: boolean;
  /**
   * Indicate for which regulatory country the requirement is for Code of the country in ISO 3166-1 alpha 3 format.
   */
  regulatoryCountryCode?: string;
}
export enum RegulatoryDetailsRequirementsRegulatoryType {
  ...
  NexusCard = 'nexusCard',
  TracingPrimaryPhone = 'tracingPrimaryPhone',
  TracingSecondaryPhone = 'tracingSecondaryPhone',
  TracingEmail = 'tracingEmail',
  TravelerQuestionnaire = 'travelerQuestionnaire',
  IndianOverseasCitizenshipCard = 'indianOverseasCitizenshipCard',
}
export enum RegulatoryDetailsRequirementsDetailsType {
  Document = 'document',
  PersonalDetails = 'personalDetails',
  Address = 'address',
  Phone = 'phone',
...
export enum RegulatoryDetailsRequirementsRequiredDetailsFields {
  Name = 'name',
  BirthDate = 'birthDate',
  ...
  CountryOfResidence = 'countryOfResidence',
  Email = 'email',
  CountryExitDate = 'countryExitDate',
}
