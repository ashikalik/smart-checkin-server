...
/**
 * Inputs needed to retrieve full fare conditions based on air bound ids.
 */
export interface RawExchangeAirOfferConditionsRequest {
  /**
   * List of air bounds ids selected during the upsell, i.e. the exchange search and describing (in an encoded way) the segments/bounds, into which the original PNR is to be exchanged
   */
  airBoundIds?: string[];
  /**
   * Requested ATPCO categories of the fare conditions. If none are specified, all categories will be retrieved.
   */
  categories?: RawExchangeAirOfferConditionsRequestCategories[];
}
export enum RawExchangeAirOfferConditionsRequestCategories {
  ...
  AgentsDiscounts = 'agentsDiscounts',
  OtherDiscounts = 'otherDiscounts',
  Stopovers = 'stopovers',
  Transfers = 'transfers',
  Endorsement = 'endorsement',
  Combinability = 'combinability',
  HigherIntermediatePoints = 'higherIntermediatePoints',
  ...
  ReservationsAndTicketing = 'reservationsAndTicketing',
