 ...
 */
import type { RegulatoryDetail } from './regulatory-detail';
import type { RegulatoryDetailsCategoryRequirement } from './regulatory-details-category-requirement';
 ...
 */
export interface RegulatoryDetailsReplyData {
  /**
   ...
   */
  storedDetails?: RegulatoryDetail[];
  /**
   * List of regulatory details that have be declined by the traveler for his journey
   */
  declinedDetails?: RegulatoryDetailsReplyDataDeclinedDetails[];
  /**
   * List of regulatory details that need to be fullfilled for the passenger to be allowed to board the plane
   */
  missingDetails?: RegulatoryDetailsCategoryRequirement[];
}
export enum RegulatoryDetailsReplyDataDeclinedDetails {
