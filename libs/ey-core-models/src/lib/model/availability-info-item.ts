 ...
 */
export interface AvailabilityInfoItem {
  /**
   * Identifier of the flight referenced in the airBoundGroup.
   */
  flightId?: string;
  /**
   * Cabin for the given availability and price.
   */
  cabin?: AvailabilityInfoItemCabin;
  /**
   ...
   */
  statusCode?: AvailabilityInfoItemStatusCode;
  /**
   * Number of remaining seats for this flight. Quota is returned only at shopping time.Display of it can depend on the rules configured by the airline.
   */
  quota?: number;
  /**
   * It provides a reference to the amenities defined in the dictionary.
   */
  amenityCodes?: string[];
  /**
   * Percentage of mileage covered by this flight, based on the bound total mileage. Example:   The bound NCE-JFK is composed of two flights:   - Flight 1: NCE - CDG, mileage = 580   - Flight 2: CDG - JFK, mileage = 3635    mileagePercentage of Flight 1 is 580/(580+3635) = 13.76   mileagePercentage of Flight 2 is 3635/(580+3635) = 86.24
   */
  mileagePercentage?: number;
  /**
   * Specifies whether the flight has been upgraded.
   */
  isUpgraded?: boolean;
}
export enum AvailabilityInfoItemCabin {
  Eco = 'eco',
  EcoPremium = 'ecoPremium',
  Business = 'business',
  First = 'first',
}
export enum AvailabilityInfoItemStatusCode {
  Hk = 'HK',
  Hl = 'HL',
  Tk = 'TK',
  Un = 'UN',
