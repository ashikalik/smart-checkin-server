...
import type { MultiCurrencyAirPricingRecords } from './multi-currency-air-pricing-records';
...
export interface OrderServiceItem {
   ...
   */
  quotaStatus?: OrderServiceItemQuotaStatus;
  /**
  ...
  isExempted?: boolean;
  /**
   * Display recommendation ; true if the service is chargeable
   */
...
export enum OrderServiceItemQuotaStatus {
  Unknown = 'unknown',
