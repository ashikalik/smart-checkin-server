...
export interface CarItem {
  ...
  id: string;
  /**
   * Confirmation number related to the car booking
   */
  ...
  statusCode: string;
  /**
   * Temporary id that can be used to associate requested and returned cars. It is only valid the time of the transaction.
   */
  tid?: string;
  /**
   * Additional remarks from the car provider
   */
  remarks?: string[];
  travelerIds?: string[];
}
