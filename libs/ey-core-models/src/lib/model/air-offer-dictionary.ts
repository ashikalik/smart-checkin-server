 ...
 */
import type { AmenitiesDictionaryItem } from './amenities-dictionary-item';
...
import type { FareConditionsDictionaryItem } from './fare-conditions-dictionary-item';
...
export interface AirOfferDictionary {
  /**
  ...
  /**
   * Status map for offer items. For more details please see [Maps in dictionary documentation] (../../display/documentation.html#/Maps/get_)
   */
  bookingStatus?: Record<string, BookingStatusDictionaryItem>;
  /**
   * FareConditions description. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  fareConditions?: Record<string, FareConditionsDictionaryItem>;
  /**
   * Services map. For more details please see [Maps in dictionary documentation](https://spec-portal.dapi.digitalforairlines.com/swagger-ui/display/documentation#/Maps/get_)
   */
  service?: Record<string, ServiceDictionaryItem>;
  /**
   * Provides explanations for travel solution unavailability reason codes
   */
  unavailabilityReason?: Record<string, string>;
  /**
   * Amenities description. For more details please see [Maps in dictionary documentation](../../display/documentation.html#/Maps/get_)
   */
  amenities?: Record<string, AmenitiesDictionaryItem>;
  /**
