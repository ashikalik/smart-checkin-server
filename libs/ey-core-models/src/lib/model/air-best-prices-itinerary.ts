 ...
 */
import type { CityPair } from './city-pair';
import type { Connection } from './connection';
import type { EndPointLocations } from './end-point-locations';

/**
 * Description of an itinerary subject of an air calendar instant search
 */
export interface AirBestPricesItinerary {
  /**
   ...
   */
  originLocationType?: AirBestPricesItineraryOriginLocationType;
  /**
   * Specify the type of the destination location between city or airport (state is not supported).
   */
  destinationLocationType?: AirBestPricesItineraryDestinationLocationType;
  /**
  ...
  /**
   * Specify the days of the week to consider for the search for the current bound. By default, all days are considered
   */
  daysOfWeek?: AirBestPricesItineraryDaysOfWeek[];
  additionalLocations?: EndPointLocations;
  /**
   * Additional locations for either departure or destination for a search returning recommendation for all combinations. Additional locations can not be provided with additional city pairs. (e.g. for the origins of PAR and TYO and destinations of BKK and LAX, the result contains recommendations for PAR-BKK, PAR-LAX, TYO-BKK and TYO-LAX)
   */
  additionalCityPairs?: CityPair[];
}
export enum AirBestPricesItineraryOriginLocationType {
  Airport = 'airport',
  City = 'city',
}
export enum AirBestPricesItineraryDestinationLocationType {
  Airport = 'airport',
  City = 'city',
}
export enum AirBestPricesItineraryDaysOfWeek {
  Monday = 'monday',
  Tuesday = 'tuesday',
  Wednesday = 'wednesday',
  Thursday = 'thursday',
