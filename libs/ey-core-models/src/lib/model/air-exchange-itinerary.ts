 ...
 */
export interface AirExchangeItinerary {
  /**
   ...
   */
  originLocationType?: AirExchangeItineraryOriginLocationType;
  /**
   * Specify the type of the destination location between city or airport (state is not supported).
   */
  destinationLocationType?: AirExchangeItineraryDestinationLocationType;
  /**
   ...
   */
  action?: AirExchangeItineraryAction;
  /**
   * This defines which bound needs to searched for the bound-by-bound search, in the given itinerary.
   */
  isRequestedBound?: boolean;
}
export enum AirExchangeItineraryOriginLocationType {
  Airport = 'airport',
  City = 'city',
}
export enum AirExchangeItineraryDestinationLocationType {
  Airport = 'airport',
  City = 'city',
}
export enum AirExchangeItineraryAction {
  Change = 'change',
  Keep = 'keep',
  Add = 'add',
  Remove = 'remove',
