 ...
 */
import type { AncillaryServicePackDetails } from './ancillary-service-pack-details';
...
import type { ServiceCataloguePricingRecords } from './service-catalogue-pricing-records';
 ...
 */
export interface ServicesCatalogueItem {
  /**
   ...
   */
  quotaStatus?: ServicesCatalogueItemQuotaStatus;
  /**
  ...
  prices?: ServiceCataloguePricingRecords;
  /**
   * Travelers associated to this service. The traveler id refers to the traveler dictionary.
   */
  travelerIds?: string[];
  packDetails?: AncillaryServicePackDetails;
  /**
   * List of service IDs of the master pack services
   */
  packServiceIds?: string[];
  /**
   * Indicates if the service should be limited to one occurence per passenger and flight
   */
  oncePerPassengerPerFlight?: boolean;
}
export enum ServicesCatalogueItemQuotaStatus {
  Unknown = 'unknown',
