...
import type { ServicePackDetails } from './service-pack-details';
...
export interface ServiceItem {
   ...
   */
  quotaStatus?: ServiceItemQuotaStatus;
  /**
  ...
  packDetails?: ServicePackDetails;
  /**
   * Service ID of the master pack
   */
  packServiceId?: string;
  milesRedemptionDetails?: ServiceMilesRedemptionRequest;
}
export enum ServiceItemQuotaStatus {
  Unknown = 'unknown',
