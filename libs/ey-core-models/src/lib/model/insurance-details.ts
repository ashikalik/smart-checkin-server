 ...
 */
import type { CoverageInsurance } from './coverage-insurance';
import type { InsuranceDetail } from './insurance-detail';
...
export interface InsuranceDetails {
   ...
   */
  logo?: InsuranceDetail[];
  /**
   * A list of text or URL based information associated to the insurance offer
   */
  information?: InsuranceDetail[];
  /**
   * A list of text or URL based information associated to the insurance offer
   */
  images?: InsuranceDetail[];
  /**
   * A list of text or URL based information associated to the insurance offer
   */
  marketingText?: InsuranceDetail[];
  /**
   * A list of text or URL based information associated to the insurance offer
   */
  privacyPolicy?: InsuranceDetail[];
  /**
   * A list of text or URL based information associated to the insurance offer
   */
  declaration?: InsuranceDetail[];
  /**
   * A list of text or URL based information associated to the insurance offer
   */
  coverages?: CoverageInsurance[];
  /**
   * A list of text or URL based information associated to the insurance offer
   */
  termsAndConditions?: InsuranceDetail[];
  /**
   * A list of text or URL based information associated to the insurance offer
   */
  disclosure?: InsuranceDetail[];
  /**
   * A list of text or URL based information associated to the insurance offer
   */
  disclaimer?: InsuranceDetail[];
}
