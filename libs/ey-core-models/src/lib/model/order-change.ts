...
/**
 * Order change sub-resource contains the transitional representation of the order under change, i.e. including changes that have been done in the  parent order but not yet committed. This sub-resource has limited life duration and will expire as soon as  the changes are committed and retrofitted in the order. The parent order always contains the latest committed changes.
 */
export interface OrderChange {
  ...
  /**
   * Identifier of the order change sub-resource
   */
  id: string;
  /**
