...
export interface JourneyPaymentRequest {
   ...
   */
  paymentOperationType?: JourneyPaymentRequestPaymentOperationType;
  /**
...
export enum JourneyPaymentRequestPaymentOperationType {
  Services = 'services',
  Upgrade = 'upgrade',
