...
@Controller('ffp-booking')
export class FfpBookingOrchestratorController {
  constructor(
    private readonly orchestrator: FfpBookingOrchestratorService,
  ...
  private attachExtrasIfEnabled(
    ...
    const enableSteps = this.configService.get<string>('FFP_BOOKING_ENABLE_STEPS') === 'true';
    const enableGoal = this.configService.get<string>('FFP_BOOKING_ENABLE_GOAL') === 'true';
