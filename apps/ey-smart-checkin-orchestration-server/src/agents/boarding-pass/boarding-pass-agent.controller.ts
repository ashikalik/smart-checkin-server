...
export class BoardingPassAgentController {
  constructor(
    private readonly Agent: BoardingPassAgentService,
  ...
  private attachExtrasIfEnabled(
    ...
    const enableSteps = this.configService.get<string>('BOARDING_PASS_ENABLE_STEPS') === 'true';
    const enableGoal = this.configService.get<string>('BOARDING_PASS_ENABLE_GOAL') === 'true';
