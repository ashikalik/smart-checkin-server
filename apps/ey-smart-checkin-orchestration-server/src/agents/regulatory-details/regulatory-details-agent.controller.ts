...
@Controller('regulatory-details')
export class RegulatoryDetailsAgentController {
  constructor(
    private readonly Agent: RegulatoryDetailsAgentService,
  ...
  private attachExtrasIfEnabled(
    ...
    const enableSteps = this.configService.get<string>('REGULATORY_DETAILS_ENABLE_STEPS') === 'true';
    const enableGoal = this.configService.get<string>('REGULATORY_DETAILS_ENABLE_GOAL') === 'true';
