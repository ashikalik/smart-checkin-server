...
@Controller('journey-identification')
export class JourneyIdentificationAgentController {
  constructor(
    private readonly Agent: JourneyIdentificationAgentService,
  ...
  private attachExtrasIfEnabled(
    ...
    const enableSteps = this.configService.get<string>('JOURNEY_IDENTIFICATION_ENABLE_STEPS') === 'true';
    const enableGoal = this.configService.get<string>('JOURNEY_IDENTIFICATION_ENABLE_GOAL') === 'true';
